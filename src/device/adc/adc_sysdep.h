...
#define ADC_CS_ERR \
  (1 << 9)  // The most recent ADC conversion encountered an error.
#define ADC_CS_ERR_STICKY \
  (1 << 10)  // Some past ADC conversion encountered an error.
#define ADC_CS_AINSEL \
  (0x00007000)  // Select analog mux input. Updated automatically in roundrobin
                // mode.
