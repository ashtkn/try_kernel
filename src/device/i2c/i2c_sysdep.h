...
#define I2C_DATA_CMD(u) \
  (ba[u] + I2Cx_DATA_CMD)  // I2C Rx/Tx Data Buffer and Command Register
#define I2C_SS_SCL_HCNT(u) \
  (ba[u] +                 \
   I2Cx_SS_SCL_HCNT)  // Standard Speed I2C Clock SCL High Count Register
#define I2C_SS_SCL_LCNT(u) \
  (ba[u] + I2Cx_SS_SCL_LCNT)  // Standard Speed I2C Clock SCL Low Count Register
#define I2C_FS_SCL_HCNT(u) \
  (ba[u] + I2Cx_FS_SCL_HCNT)  // Fast Mode or Fast Mode Plus I2C Clock SCL High
                              // Count Register
#define I2C_FS_SCL_LCNT(u) \
  (ba[u] + I2Cx_FS_SCL_LCNT)  // Fast Mode or Fast Mode Plus I2C Clock SCL Low
                              // Count Register
#define I2C_INTR_STAT(u) \
  (ba[u] + I2Cx_INTR_STAT)  // I2C Interrupt Status Register
#define I2C_INTR_MASK(u) \
  (ba[u] + I2Cx_INTR_MASK)  // I2C Interrupt Mask Register
#define I2C_RAW_INTR_STAT(u) \
  (ba[u] + I2Cx_RAW_INTR_STAT)  // I2C Raw Interrupt Status Register
#define I2C_RX_TL(u) \
  (ba[u] + I2Cx_RX_TL)  // I2C Receive FIFO Threshold Register
#define I2C_TX_TL(u) \
  (ba[u] + I2Cx_TX_TL)  // I2C Transmit FIFO Threshold Register
#define I2C_CLR_INTR(u) \
  (ba[u] + I2Cx_CLR_INTR)  // Clear Combined and Individual Interrupt Register
#define I2C_CLR_RX_UNDER(u) \
  (ba[u] + I2Cx_CLR_RX_UNDER)  // Clear RX_UNDER Interrupt Register
#define I2C_CLR_RX_OVER(u) \
  (ba[u] + I2Cx_CLR_RX_OVER)  // Clear RX_OVER Interrupt Register
#define I2C_CLR_TX_OVER(u) \
  (ba[u] + I2Cx_CLR_TX_OVER)  // Clear TX_OVER Interrupt Register
#define I2C_CLR_RD_REQ(u) \
  (ba[u] + I2Cx_CLR_RD_REQ)  // Clear RD_REQ Interrupt Register
#define I2C_CLR_TX_ABRT(u) \
  (ba[u] + I2Cx_CLR_TX_ABRT)  // Clear TX_ABRT Interrupt Register
#define I2C_CLR_RX_DONE(u) \
  (ba[u] + I2Cx_CLR_RX_DONE)  // Clear RX_DONE Interrupt Register
#define I2C_CLR_ACTIVITY(u) \
  (ba[u] + I2Cx_CLR_ACTIVITY)  // Clear ACTIVITY Interrupt Register
#define I2C_CLR_STOP_DET(u) \
  (ba[u] + I2Cx_CLR_STOP_DET)  // Clear STOP_DET Interrupt Register
#define I2C_CLR_START_DET(u) \
  (ba[u] + I2Cx_CLR_START_DE)  // Clear START_DET Interrupt Register
#define I2C_CLR_GEN_CALL(u) \
  (ba[u] + I2Cx_CLR_GEN_CALL)  // Clear GEN_CALL Interrupt Register
...
#define I2C_SDA_HOLD(u) \
  (ba[u] + I2Cx_SDA_HOLD)  // I2C SDA Hold Time Length Register
#define I2C_TX_ABRT_SOURCE(u) \
  (ba[u] + I2Cx_TX_ABRT_SOURCE)  // I2C Transmit Abort Source Register
#define I2C_SLV_DATA_NACK_ONLY(u) \
  (ba[u] + I2Cx_SLV_DATA_NACK_ONLY)  // Generate Slave Data NACK Register
#define I2C_DMA_CR(u) (ba[u] + I2Cx_DMA_CR)  // DMA Control Register
#define I2C_DMA_TDLR(u) \
  (ba[u] + I2Cx_DMA_TDLR)  // DMA Transmit Data Level Register
#define I2C_DMA_RDLR(u) \
  (ba[u] + I2Cx_DMA_RDLR)  // DMA Transmit Data Level Register
#define I2C_SDA_SETUP(u) (ba[u] + I2Cx_SDA_SETUP)  // I2C SDA Setup Register
#define I2C_ACK_GENERAL_CALL(u) \
  (ba[u] + I2Cx_ACK_GENERAL_CALL)  // I2C ACK General Call Register
#define I2C_ENABLE_STATUS(u) \
  (ba[u] + I2Cx_ENABLE_STATUS)  // I2C Enable Status Register
#define I2C_FS_SPKLEN(u) \
  (ba[u] + I2Cx_FS_SPKLEN)  // I2C SS, FS or FM+ spike suppression limit
#define I2C_CLR_RESTART_DET(u) \
  (ba[u] + I2Cx_CLR_RESTART_DET)  // Clear RESTART_DET Interrupt Register
#define I2C_COMP_PARAM_1(u) \
  (ba[u] + I2Cx_COMP_PARAM_1)  // Component Parameter Register 1
#define I2C_COMP_VERSION(u) \
  (ba[u] + I2Cx_COMP_VERSION)  // I2C Component Version Register
#define I2C_COMP_TYPE(u) \
  (ba[u] + I2Cx_COMP_TYPE)  // I2C Component Type Register
